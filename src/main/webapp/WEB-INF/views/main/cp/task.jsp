	...
	<div class="panel panel-default"
		...
		<div class="panel-heading">
			<h4 class="panel-title">
				<span class="glyphicon glyphicon-pushpin"></span> 通用接口
			</h4>
		</div>
...
;({
	table : {
		...
		orderCase : '',
		isAllowMulit : true,
		uri : '../task/getTasks?deleted=0&taskType=0&interTag=0',
		util :[{name : '添加任务', type : 'btn', direct:'left', css:'btn btn-default', icon : 'glyphicon glyphicon-plus', uri : '../task/insertTask', func:'add'},
	              ...
	              {name : '立即运行', type : 'btn', direct:'left', css:'btn btn-default', icon : 'glyphicon glyphicon-play', uri : '', func:'extend', item : 'mulit', extend:'runTask'},
	              ...
	              {name : '业务类型', type : 'btnG', direct:'right', css:'btn btn-success', icon : 'glyphicon glyphicon-search', uri : [
 			              {name : '网络爬取', type : 'btn', css:'btn btn-default', icon : 'glyphicon glyphicon-random', uri : '../task/getTasks?deleted=0&taskType=1&interTag=0', func:'refresh'},
 			              {name : '数据对接', type : 'btn', css:'btn btn-default', icon : 'glyphicon glyphicon-retweet', uri : '../task/getTasks?deleted=0&taskType=2&interTag=0', func:'refresh'},
 			              {name : '全部任务', type : 'btn', css:'btn btn-default', icon : 'glyphicon glyphicon-list', uri : '../task/getTasks?deleted=0&taskType=0&interTag=0', func:'refresh'},
    		      		]}
	              ],
	     field : [{name : 'ID', text : 'ID', isShow : true,  type:'INDEX',popover:false, readonly:true}, 
			         ...
			         {name : 'InterTag', text : '', isShow : false,  type:'sys', value:0, popover:false},
